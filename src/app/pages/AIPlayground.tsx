...
import { ProjectCard, aiPlaygroundCards } from "../components/ProjectCard";
...
const pageStyles = `
  ...
  @media (max-width: 768px) {
    .ai-cards-row { flex-direction: column !important; }
    .ai-section-pad { padding: 48px 24px !important; }
    .ai-cta-inner { flex-direction: column !important; gap: 24px !important; padding: 48px 24px !important; }
  }
`;
        ...
        >
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", flex: 1, minWidth: "200px" }}>
              ...
              >
                Deep dives into the design decisions that actually mattered.
              </p>
            </div>
            <Link
              to="/case-studies"
